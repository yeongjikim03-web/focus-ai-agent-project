...
while True:
    ...
    # title이나 앱 달라질때 or 앱 안달라지고 10초 지났을때 

    app_change = current_title != prev_title or current_app != prev_app 
   
    if app_change or not app_change and (time.time() - present_time >= 10):
